...
var ResolveDisputeDto = /** @class */ (function () {
    function ResolveDisputeDto() {
    }
    __decorate([
        (0, class_validator_1.IsString)(),
        (0, class_validator_1.MinLength)(10, { message: 'Resolution must be at least 10 characters' })
    ], ResolveDisputeDto.prototype, "resolution");
    return ResolveDisputeDto;
}());
var AdminController = /** @class */ (function () {
    function AdminController(prisma) {
        this.prisma = prisma;
    }
    ...
    AdminController.prototype.suspendUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.user.update({ where: { id: id }, data: { isActive: false } })];
            });
        });
    };
    AdminController.prototype.getDisputes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.dispute.findMany({
                        include: { contract: { include: { freelanceJob: true, client: true, freelancer: true } } }
                    })];
            });
        });
    };
    AdminController.prototype.resolveDispute = function (id, dto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.dispute.update({
                        where: { id: id },
    ...
    ], AdminController.prototype, "resolveDispute");
