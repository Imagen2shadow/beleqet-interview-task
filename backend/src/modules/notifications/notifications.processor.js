...
var NotificationsProcessor = /** @class */ (function () {
    function NotificationsProcessor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(NotificationsProcessor_1.name);
    }
    NotificationsProcessor_1 = NotificationsProcessor;
    NotificationsProcessor.prototype.handleSendInApp = function (job) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.logger.log("[send-in-app] Sending notification to user ".concat(job.data.userId));
                        return [4 /*yield*/, this.prisma.notification.create({
                                data: {
                                    ...
                                    body: job.data.body,
                                    metadata: (_a = job.data.metadata) !== null && _a !== void 0 ? _a : {}
                                }
                            })];
                    case 1:
                        _b.sent();
    ...
    NotificationsProcessor.prototype.handleSendTelegram = function (job) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.logger.log("[send-telegram] Sending to telegram ID ".concat(job.data.telegramId));
                return [2 /*return*/];
            });
        });
    };
    ...
    ], NotificationsProcessor.prototype, "handleSendInApp");
    __decorate([
        (0, bull_1.Process)(queues_constants_1.NOTIFICATION_JOBS.SEND_TELEGRAM)
    ], NotificationsProcessor.prototype, "handleSendTelegram");
